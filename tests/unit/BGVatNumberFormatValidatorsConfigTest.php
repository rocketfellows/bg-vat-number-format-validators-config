...
namespace rocketfellows\BGVatNumberFormatValidatorsConfig\tests\unit;

use arslanimamutdinov\ISOStandard3166\ISO3166;
use PHPUnit\Framework\TestCase;
use rocketfellows\BGVatFormatValidator\BGVatFormatValidator;
use rocketfellows\BGVatNumberFormatValidatorsConfig\BGVatNumberFormatValidatorsConfig;
...
class BGVatNumberFormatValidatorsConfigTest extends TestCase
{
    private const TESTING_CONFIG_CLASS = BGVatNumberFormatValidatorsConfig::class;
    private const EXPECTED_CONFIG_DEFAULT_VALIDATOR_CLASS = BGVatFormatValidator::class;
    ...
    {
        $this->assertEquals(ISO3166::BG(), $config->getCountry());
    }
